...
const AddCampaign: React.FC<AddCampaignProps> = ({ isVisible, onClose }) => {
      ...
      <View style={styles.centeredView}>
        <SafeAreaView style={styles.modalView}>
          <View style={styles.header}>
            <Text style={styles.title}>Tạo chiến dịch</Text>
            
          </View>
          <ScrollView contentContainerStyle={styles.content}>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>
                Tên chiến dịch <Text style={styles.required}>*</Text>
              </Text>
              <TextInput
                style={[
                  styles.input,
            ...
            <View style={styles.row}>
              <View style={styles.column}>
                <Text style={styles.label}>
                  Đơn vị áp dụng <Text style={styles.required}>*</Text>
                </Text>
            ...
            <View style={styles.row}>
              <View style={styles.column}>
                <View style={styles.inputContainer}>
                  <Text style={styles.label}>
                    Số ứng viên kỳ vọng  <Text style={styles.required}>*</Text>
                  </Text>
                  <TextInput
                    style={[
                      styles.input,
