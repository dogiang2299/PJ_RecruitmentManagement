...
export default function RecruitmentCampaignPage() {
  const router = useRouter();
    const [time, setTime] = React.useState("Chọn đơn vị sử dụng");
    const [date, setDate] = useState(new Date());
  
  const [openStatus, setOpenStatus] = useState(false);
  const [valueStatus, setValueStatus] = useState("Tất cả");
...
const optionFunction: OptionFunction[] = [
  ...
  return (
    <View style={{ flexDirection: "column", gap: 5, paddingVertical: 30, paddingHorizontal: 15}}>
      ...
      >
        <Text style={{ fontSize: 20, fontWeight: 700 }}>Chiến dịch tuyển dụng</Text>
        {/* <TouchableOpacity
          style={{
          ...
          <View style={styles.header}>
            ...
            <View style={{ flex: 1, marginLeft: 8 }}>
              ...
              <View style={styles.subInfo}>
                ...
                >
                  <Text style={styles.subText}>Gửi email, tổ chức hội thảo</Text>
                  <Text style={styles.subText}>• Tiểu Tun Thị Đỗ</Text>
                  <Text style={styles.subText}>0</Text>
                  <Text style={styles.subText}>Ứng viên</Text>
                </View>
              </View>
            </View>
...
{/* Stats row */}
          <View style={styles.statsRow}>
            <TouchableOpacity style={[styles.statItem]}>
              ...
              <Text style={styles.statLabel}>Đang cân nhắc</Text>
            </TouchableOpacity>
            <Border />
            <TouchableOpacity style={[styles.statItem]}>
                <Text style={styles.statNumber}>-</Text>
            ...
            <TouchableOpacity style={[styles.statItem]}>
                <Text style={styles.statNumber}>-</Text>
              <Text style={styles.statLabel}>Đã gửi CV</Text>
            </TouchableOpacity>
            <Border />
            <TouchableOpacity style={[styles.statItem]}>
                <Text style={styles.statNumber}>-</Text>
              <Text style={styles.statLabel}>Đã chuyển đến tin</Text>
            </TouchableOpacity>
            <Border />
            <TouchableOpacity style={[styles.statItem]}>
                <Text style={styles.statNumber}>-</Text>
          ...
          </View>          {/* Dropdown hiển thị ngay dưới nút */}
          {visibleFunction && (
