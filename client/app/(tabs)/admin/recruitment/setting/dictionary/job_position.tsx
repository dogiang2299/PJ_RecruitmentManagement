...
const JobPositionItem: React.FC<{ item: JobPosition }> = ({ item }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 15, }}>
        ...
        <View style={{ flexDirection: "column" }}>
          ...
          <Text style={{fontSize: 20, fontWeight: 700}}>Vị trí công việc</Text>
          <View style={styles.syncRow}>
            ...
            />
            <Text style={styles.syncLabel}>    Tự động đồng bộ từ Hệ thống</Text>
          </View>
        </View>
        <View>
          <Text style={styles.syncLabel}>Quản lý các vị trí công việc mà bạn cần tuyển dụng</Text>
        </View>
        </View>
        {/* Nav phải */}
        <View style={styles.actionBar}>
                    <TouchableOpacity style={styles.buttonNavRight}>
                      <Feather name="refresh-ccw" size={17} color="#7A8188" />
                      <Text>Lấy dữ liệu</Text>
                    </TouchableOpacity>
          
          <TouchableOpacity style={styles.buttonNavRight}>
            <MaterialCommunityIcons name="export" size={20} color="#7A8188" />
            <Text>Xuất khẩu</Text>
          </TouchableOpacity>
