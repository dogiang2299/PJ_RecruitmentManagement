...
export default function RankRecruitment() {
    // Bảng
  ...
  const renderTableRow = (item: Career) => (
    <View key={item.id} style={styles.tableRow}>
      ...
      <Text style={[styles.cell, { flex: 2  }  ]}>{item.describe}</Text>
  ...
  return (
          ...
          >
            <View>
                          <Text style={{ fontSize: 23, fontWeight: 700, marginBottom: 10 }}>Ngành nghề</Text>
            <Text>Quản lý các ngành nghề hiển thị trên website</Text>
...
// Style chung cho mỗi ô dữ liệu
cell: {
    paddingHorizontal: 8,
    // Đảm bảo nội dung căn giữa chiều dọc
    justifyContent: 'center', 
    height: '100%', // Quan trọng để các ô đều có chiều cao bằng nhau
},

// Style cho Text bên trong ô
cellText: {
    fontSize: 14,
    color: '#333',
    // Giúp ngăn văn bản xuống dòng
},
  headerCell: {
    fontWeight: 'bold',
    color: '#555',
